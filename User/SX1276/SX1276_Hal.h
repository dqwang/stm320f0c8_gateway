...
//RF_CS
#define RF_CS_H  		GPIO_SetBits(GPIOA,GPIO_Pin_15)
#define RF_CS_L  		GPIO_ResetBits(GPIOA,GPIO_Pin_15)

#define RF_RST_H  		GPIO_SetBits(GPIOA,GPIO_Pin_11)
#define RF_RST_L  		GPIO_ResetBits(GPIOA,GPIO_Pin_11)


#define RF2_CS_H  		GPIO_SetBits(GPIOF,GPIO_Pin_6)
#define RF2_CS_L  		GPIO_ResetBits(GPIOF,GPIO_Pin_6)
